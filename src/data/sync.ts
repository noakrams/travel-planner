...
function remotePayload(entry: OutboxEntry) {
  ...
  if (entry.entity === 'item') {
    ...
    switch (payload.kind) {
      case 'activity': return { ...base, day_id: payload.dayId, item_type: 'activity', title: payload.title, start_time: payload.startTime || null, end_time: payload.endTime || null, location_name: payload.location || null, maps_url: payload.mapsUrl || null, description: payload.description, status: normalizeRemoteStatus(payload.status), planned_amount: payload.plannedAmount ?? null, actual_amount: payload.actualAmount ?? null, currency: payload.currency ?? null, position: payload.position }
      case 'booking': return { ...base, itinerary_item_id: null, booking_type: 'reservation', title: payload.title, provider: payload.provider || null, confirmation_code: payload.confirmationCode || null, starts_at: null, ends_at: null, status: normalizeRemoteStatus(payload.status), notes: payload.description, planned_amount: payload.plannedAmount ?? null, actual_amount: payload.actualAmount ?? null, currency: payload.currency ?? null, position: payload.position }
      case 'stay': return { ...base, name: payload.title, location: payload.location || null, check_in: null, check_out: null, maps_url: payload.mapsUrl || null, booking_id: null, notes: payload.description, planned_amount: payload.plannedAmount ?? null, actual_amount: payload.actualAmount ?? null, currency: payload.currency ?? null, position: payload.position }
      case 'transport': return { ...base, transport_type: 'other', title: payload.title, provider: payload.provider || null, origin: null, destination: payload.location || null, departs_at: null, arrives_at: null, booking_id: null, status: normalizeRemoteStatus(payload.status), notes: payload.description, planned_amount: payload.plannedAmount ?? null, actual_amount: payload.actualAmount ?? null, currency: payload.currency ?? null, position: payload.position }
      case 'place': return { ...base, category: 'place', name: payload.title, location: payload.location || null, maps_url: payload.mapsUrl || null, notes: payload.description, status: payload.status || 'saved', position: payload.position }
      case 'food': return { ...base, category: 'restaurant', name: payload.title, location: payload.location || null, maps_url: payload.mapsUrl || null, notes: payload.description, status: payload.status || 'saved', position: payload.position }
      case 'note': return { ...base, day_id: payload.dayId || null, note_type: 'note', title: payload.title, body: payload.description, priority: 0, position: payload.position }
      case 'warning': return { ...base, day_id: payload.dayId || null, title: payload.title, body: payload.description, severity: 'notice', position: payload.position }
      case 'route': return { ...base, city: payload.title, arrival_date: null, departure_date: null, maps_url: payload.mapsUrl || null, notes: payload.description, position: payload.position }
      case 'expense': return { ...base, itinerary_item_id: null, category: 'other', title: payload.title, planned_amount: payload.plannedAmount ?? 0, actual_amount: payload.actualAmount ?? 0, currency: payload.currency ?? 'USD', paid: payload.paid ?? false, occurred_on: payload.occurredOn ?? null, notes: payload.description, position: payload.position }
      default: return base
    }
  }
  return payload
